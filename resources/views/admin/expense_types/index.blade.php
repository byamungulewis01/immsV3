                                        ...
                                        <div class="modal-dialog model-lg">
                                            <div class="modal-content">
                                                <div class="modal-header p-3">
                                                    <h5 class="modal-title">Expense Type Registration
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close" id="close-modal"></button>
                                                </div>
                                                <form class="tablelist-form" method="post"
                                                    action="{{ route('admin.expense_types.store') }}"
                                    ...
                                    <td>
                                        ...
                                        @can('delete expense types')
                                            <a href="#deleteRecordModal" data-bs-toggle="modal" type="button"
                                                data-action="{{ route('admin.expense_types.destroy', $expense_type->et_id) }}"
    ...
    @can('update item')
        ...
        <div class="modal fade zoomIn" id="updatemodal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Expense Type Update
                        </h5>
                        ...
                        <form method="post" id="itemupdate" action="#">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="editname-field" name="editname" class="form-control"
                                    placeholder="editname" value="{{ old('editname') }}" required />
                                <div class="invalid-feedback">
                                    Please enter name.
                                </div>
                            </div>
