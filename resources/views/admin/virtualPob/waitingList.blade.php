                                ...
                                <tr>
                                    ...
                                    <td class="status">
                                        @if ($box->attachment == null)
                                            <span class="badge badge-pill badge-soft-danger font-size-12">No Attachment</span>
                                        @else

                                        <a href="{{ route('virtualPob.download',$box->id) }}"><span>View</span></a>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal fade" id="approve{{ $box->id }}" aria-hidden="true"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form action="{{ route('virtualPob.approve',$box->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PUT')
                                        ...
                                        <a href="" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#reject{{ $box->id }}"><span>Reject</span></a>
                                            <div class="modal fade" id="reject{{ $box->id }}" aria-hidden="true"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form action="{{ route('virtualPob.reject',$box->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="modal-body text-center p-5">
