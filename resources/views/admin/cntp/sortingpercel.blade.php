                ...
                <div class="card-body">
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th class="sort" data-sort="name"> Dispatch Code </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($inboxing->status == 2)
                                            ...
                                            <a href="{{ route('admin.cntpsort.sortingpercelview', ['id' => encrypt($inboxing->id)]) }}"
                                                            ...
                                                            <div class="accordion accordion-flush"
                                                                ...
                                                                <div class="accordion-item border-0">
                                                                    ...
                                                                    <div id="collapseFour"
                                                                        ...
                                                                        <div class="accordion-body ms-2 ps-5 pt-0">
                                                                            ...
                                                                            <p class="text-muted mb-0">{{ $inboxing->opened_date }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="accordion-item border-0">
                                                                    ...
                                                                    <div id="collapseFive"
                                                                        ...
                                                                        data-bs-parent="#accordionExample">
                                                                        <div class="accordion-body ms-2 ps-5 pt-0">
                                                                            <h6 class="mb-1">Dispacher Sorting Date
                                                                            </h6>
                                                                            <p class="text-muted mb-0">{{ $inboxing->sorting_date }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                @endif
