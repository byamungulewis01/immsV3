                                ...
                                @if ($rmt == 0)
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control quantity-input p_qty" disabled>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" disabled
                                                class="form-control quantity-input p_qty">
                                            <input type="hidden"
                                                class="form-control quantity-input p_qty " name="quantitytwo[]">
                                            <div class="input-group-append">
                                                <button type="button" disabled
                                                    class="btn btn-outline-secondary">+</button>
                                            </div>
