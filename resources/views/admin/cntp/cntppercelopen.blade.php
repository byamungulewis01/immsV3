                                                                  ...
                                                                  <div class="accordion-item border-0">
                                                                          ...
                                                                          <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                              <div class="d-flex align-items-center">
                                                                                  ...
                                                                                  <div class="flex-grow-1 ms-3">
                                                                                      <h6 class="fs-15 mb-0 fw-semibold">Dispached By- <span class="fw-normal">{{ $inboxing->ctnp->name }}</span></h6>
                                                                                  </div>
                                                                              </div>
                                                                          </a>
                                                                      </div>
                                                                      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                                                                          <div class="accordion-body ms-2 ps-5 pt-0">
                                                                              <h6 class="mb-1">Dispacher Registered Date</h6>
                                                                              <p class="text-muted mb-0">{{ $inboxing->created_at->format('l, d M Y - H:m') }}</p>
                                                                          </div>
                                                                      </div>
                                                                  </div>
                                                                  <div class="accordion-item border-0">
                                                                      <div class="accordion-header" id="headingTwo">
                                                                          <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                              <div class="d-flex align-items-center">
                                                                                  ...
                                                                                  <div class="flex-grow-1 ms-3">
                                                                                      <h6 class="fs-15 mb-1 fw-semibold">Transfered By - <span class="fw-normal">{{ $inboxing->ctnp->name }}</span></h6>
                                                                                  </div>
                                                                              </div>
                                                                          </a>
                                                                      </div>
                                                                      <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                                          <div class="accordion-body ms-2 ps-5 pt-0">
                                                                              <h6 class="mb-1">Dispacher Transfered Date</h6>
                                                                              <p class="text-muted mb-0">{{ $inboxing->transfer_date }}</p>
                                                                          </div>
                                                                      </div>
                                                                  </div>
                                                                  <div class="accordion-item border-0">
                                                                      <div class="accordion-header" id="headingThree">
                                                                          <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                                              <div class="d-flex align-items-center">
                                                                                  ...
                                                                                  <div class="flex-grow-1 ms-3">
                                                                                      <h6 class="fs-15 mb-1 fw-semibold">Dispacher Received BY - <span class="fw-normal">{{ $inboxing->receiver->name }}</span></h6>
                                                                                  </div>
                                                                              </div>
                                                                          </a>
                                                                      </div>
                                                                      <div id="collapseThree" class="accordion-collapse collapse show" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                                          <div class="accordion-body ms-2 ps-5 pt-0">
                                                                              <h6 class="mb-1">Dispacher Received Date</h6>
                                                                              <p class="text-muted mb-0">{{ $inboxing->cntppickupdate }}</p>
                                                                          </div>
                                                                      </div>
                                                                  </div>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <select class="form-control" required
                                                                            name="cntpcomment" id="branch">
                                                                            @foreach ($comments as $comment)
                                                                                <option selected  value="{{ $comment->name }}">
                                                                                    {{ $comment->name }}</option>
                                                                            @endforeach
                                                            ...
                                                            @elseif ($inboxing->dispachetype == 'Mails')
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <h3>If This Dispatch have Registered Mail ? Please check
                                                                    </h3>
                                                                    <h3>If This Dispatch have Not Registered Mail ? Please
                                                                        Not check</h3>
                                                                    <div
