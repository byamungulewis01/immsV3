                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            @if ((!is_null($inboxing->mailnumberreg) && $inboxing->regstatus == 2))
                                ...
                                <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form class="tablelist-form" id="myForm" method="post" action="{{ route('admin.cntp.fillingreg',$inboxing->id) }}">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="name-field" class="form-label">Registered Package</label>
                                                            <input type="number" id="email-field" class="form-control" name="rm"
                                                                placeholder="Enter Number Of Registered Package" value="{{ old('rm') }}"autocomplete="off" />
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text"  id="email-field" class="form-control" name="rmweight"
                                                                placeholder="Enter Registered Package Weight" value="{{ old('rmweight') }}"autocomplete="off" />
                                                            <div class="invalid-feedback">
                                                       ...
                                                       <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="name-field" class="form-label">Registerd Letter</label>
                                                            <input type="number"  id="email-field" class="form-control" name="rl"
                                                                placeholder="Enter Number Of Registered Letter" value="{{ old('rl') }}"autocomplete="off" />
                                                            <div class="invalid-feedback">
                                                                Please enter Ordinary Letter
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="name-field" class="form-label">Weight/Kg</label>
                                                            <input type="text" id="email-field" class="form-control" name="rlweight"
                                                                placeholder="Enter Registered Letter Weight" value="{{ old('rlweight') }}"autocomplete="off" />
                                                            <div class="invalid-feedback">
                                                                Please enter Number Registerd Letter
                                                            </div>
                                                        </div>
                                                       </div>
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                <label for="branch" class="form-label">Comment</label>
                                                                <select class="form-control" name="rpcomment"
                                                                    id="branch">
                                                                    <option value="" disabled selected>Select Comment</option>
                                                                    @foreach ($comments as $comment)
                                                                    <option @if (old('rpcomment')==$comment->name) selected @endif
                                                                        value="{{ $comment->name }}">{{ $comment->name }}</option>
                                                                    @endforeach
