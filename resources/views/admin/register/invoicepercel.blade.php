...
<head>
    <title>Registered Mail Transfer</title>
    <style>
        body {
...
<div class="watermark">PERCEL MAIL TRANSFER</div>

<body>
    <p style="font-size: 14px; font-weight: bold;">REPUBLIC OF RWANDA<br>
        NATIONAL POSTS OFFICE<br>
        <img src="{{ public_path('img/logo.png') }}" alt="Girl in a jacket" width="120" height="70">
        <br>
    ...
    <h1 style="text-align:center">MAIL TRANSFER FORM NO: MT {{ $idd }} </h1>

    <table width="100%">

        @empty($inboxings)
        <h2>Total Mail Transfered ------------  <strong style="color: tomato">{{ $number }}</strong></h2>
        @else
        <thead>
            <tr>
                <th>#</th>
