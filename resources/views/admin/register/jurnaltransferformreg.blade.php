                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            ...
                            <button type="button" class="btn btn-primary " data-bs-toggle="modal"
                                data-bs-target="#myModal">Jurnal Package Transfer By Number</button>
                            <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
                                aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">JURNAL PACKAGE TRANSFER BY NUMBER IN
                                                {{ $bra->name }} BRANCH</h5>
                                        ...
                                        <div class="modal-body">
                                            <input type="hidden" name="touserid" id="simpleinput" class="form-control"
                                                required value={{ $bra->id }} name="mnumber">
                                            <label for="customername-field" class="form-label">

                                                NUMBER OF JURNAL PACKAGE</label>
                                            <div class="mb-3">
                                                <input type="number" name="mnumber" id="simpleinput" class="form-control"
                                                    required name="mnumber" autocomplete="off">
                                            </div>
                                        </div>
                                ...
                                @foreach ($results as $key => $result)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.transferjurnal.invoicejurnal', encrypt($result->id)) }}"
                                                class="btn btn-sm btn-primary" target="_blank">PRINT</a>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header bg-light p-3">
                                    <h5 class="modal-title" id="exampleModalLabel"> JURNAL MAIL TRANSFER IN
                                        {{ $bra->name }} BRANCH </h5>
