        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                @foreach ($bras as $key => $bra)
                    <h4 class="mb-sm-0">Registered Letter Registration {{ $bra->name }}</h4>
                @endforeach
        ...
        <div class="col-lg-12">
                ...
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                @foreach ($bras as $key => $bra)
                                    <h5 class="card-title mb-0">REGISTERED LETTER REGISTRATION LIST IN {{ $bra->name }}
                                    </h5>
                                @endforeach
                            </div>
                        </div>
                            ...
                            @foreach ($inboxings as $key => $inboxing)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (!is_null($inboxing->pob_bid))
                                            {{ $inboxing->pob }} {{ $inboxing->branches->name }}
                                    </td>
                            @endif
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header bg-light p-3">
                                                <h5 class="modal-title">REGISTERED LETTER INFORMATION UPDATE</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close" id="close-modal"></button>
                                            </div>
                                            <form class="tablelist-form" id="myForm" method="post"
                                                action="{{ route('admin.mailsrl.update', $inboxing->id) }}">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="customername-field" name="intracking"
                                                            ...
                                                            value="{{ $inboxing->intracking }}" autocomplete="off" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="email-field" class="form-control"
                                                            ...
                                                            value="{{ $inboxing->inname }}" autocomplete="off" />
                                                        <div class="invalid-feedback">
                                                            Please enter Names.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="phone-field" name="phone"
                                                            ...
                                                            value="{{ $inboxing->phone }}" autocomplete="off" />
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="customername-field" class="form-label">POB
                                                            </label>
                                                            <input type="text" id="customername-field" name="pob"
                                                                class="form-control" placeholder="Enter POB "
                                                                value="{{ $inboxing->pob }}" autocomplete="off" />
                                                            <div class="invalid-feedback">
                                                                Please enter POB .
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            ...
                                                            <select class="form-control" name="pob_bid" id="branch">
                                                                <option value="" disabled selected>Select branch
                                                                </option>
                                                                @foreach ($branches as $branch)
                                                                    <option
                                                                        @if ($inboxing->pob_bid == $branch->id) selected @endif
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" name="orgcountry" type="text"
                                                                ...
                                                                <option value="" disabled selected>Orgin Country
                                                                </option>
                                                                @foreach ($countries as $country)
                                                                    <option
                                                                        {{ old('orgcountry', $inboxing->orgcountry) == $country['c_id'] ? 'selected' : '' }}
                                                                        value="{{ $country['c_id'] }}">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" data-choices
                                                                ...
                                                                required>
                                                                <option @if ($inboxing->comment == 'Item recieved') selected @endif
                                                                    value="Item recieved">Item recieved</option>
                                                                <option @if ($inboxing->comment == 'Item recieved torn and Repaired at the CNTP') selected @endif
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-light p-3">
                            <h5 class="modal-title" id="exampleModalLabel">Registered Letter Registration</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                id="close-modal"></button>
                        </div>
                        <form class="tablelist-form" method="post" action="{{ route('admin.mailsrl.store') }}">
                            @csrf
                            <div class="modal-body">
                                <div class="mb-3">
                                    @if ($errors->any())
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="customername-field" name="intracking" class="form-control"
                                        placeholder="Enter Tracking Number" value="{{ old('intracking') }}"
                                        autocomplete="off" />
                                    <div class="invalid-feedback">
                                        Please enter a Tracting Number .
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="phone-field" name="phone"
                                        ...
                                        placeholder="Enter phone no." value="{{ old('phone') }}" autocomplete="off" />
                                    <div class="invalid-feedback">
                                        Please enter a phone.
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="customername-field" name="pob"
                                            class="form-control" placeholder="Enter POB " value="{{ old('pob') }}"
                                            autocomplete="off" />
                                        <div class="invalid-feedback">
                                            Please enter POB .
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label for="country" class="form-label">Orgin Country
                                    </label>
                                    <select class="form-select" name="orgcountry" type="text" id="country"
                                        required>
                                        <option value="" disabled selected>Orgin Country</option>
                                        @foreach ($countries as $country)
                                            <option {{ old('orgcountry') == $country['c_id'] ? 'selected' : '' }}
                                                value="{{ $country['c_id'] }}">{{ $country['countryname'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
