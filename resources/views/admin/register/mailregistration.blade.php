                ...
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            ...
                            <div>
                                <h5 class="card-title mb-0">ORDINARY PACKAGE  REGISTRATION BASED ON BRANCH</h5>
                            </div>
                        </div>
                        ...
                        <div class="row h-100">
                            @foreach ($branches as $branch)
                                <div class="col-lg-2 col-md-6">
                                    <div class="card">
                                        <a href="{{ route('admin.mails.Ordregistration', ['id' => encrypt($branch->id)]) }}">
