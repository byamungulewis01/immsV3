            ...
            <div class="card" id="customerList">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <form method="post" action="{{ route('admin.transferp.storen') }}">
                                @csrf
                ...
                <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{ route('admin.transferp.store') }}">
                ...
                <div class="modal fade" id="showModals" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light p-3">
                                <h5 class="modal-title" id="exampleModalLabel"> PARCEL MAIL TRANSFER IN
    ...
    <script>
        $(document).ready(function() {
            $('#datatableAjax').DataTable({
                ...
                scrollX: true,
                ajax: "{{ route('PercelApi.PerApi', ['id' => $id, 'user' => auth()->user()->id]) }}",
                columns: [{
                        data: 'idd'
                    },
                    {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            var idd = row.idd;
                            var route =
                                "{{ route('admin.transferp.invoicereg', ['idd' => ':idd']) }}";
                            route = route.replace(':idd', idd);
                            var link =
                                `<a href="${route}" class="btn btn-primary btn-sm" target="_blank"><span>PRINT</span></a>`;
                            return link;
                        }
                    },
                ],
