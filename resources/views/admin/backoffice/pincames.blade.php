...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">PERCEL MAIL INCOMES LIST</h4>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">PERCEL MAIL INCOMES LIST</h5>
                        </div>
                    </div>
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.incomep.transactionpmail', $courierPay->pdate) }}" type="button" class="btn btn-success btn-sm"><span>Transactions</span></a>
