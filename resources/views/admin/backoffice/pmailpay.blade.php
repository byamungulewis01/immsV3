            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">PARCEL MAILS</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                ...
                                <h5 class="card-title mb-0">PAYEMENT OF PARCEL MAILS LIST</h5>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form class="tablelist-form" id="myForm" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" id="customername-field" name="mailtype"
                                                            class="form-control" value="{{ $inboxing->mailtype }}" />
                                                        <div class="mb-3">
                                                            <label for="customername-field" class="form-label">MAIL CODE
                                                            </label>
                                                            <input type="text" id="customername-field"
                                                                name="innumber" class="form-control"
                                                                placeholder="Enter Tracking Number"
                                                                value="{{ $inboxing->innumber }}" readonly required />
                                        ...
                                        <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="tablelist-form" id="myForm" method="post"
                                                        action="{{ route('admin.payp.store', $inboxing->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="customername-field" class="form-label">MAIL
                                                                        CODE
                                                                    </label>
                                                                    <input type="hidden" id="email-field"
                                                                        class="form-control" name="extra" required
                                                                        value="{{ $inboxing->mailtype }}" />

                                                                    <input type="text" id="customername-field"
                                                                        name="innumber" class="form-control"
                                                                        value="{{ $inboxing->innumber }}" disabled readonly
                                                                        required />

                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="name-field" class="form-label">P.O
                                                                        Box</label>
                                                                    <input type="text" id="email-field"
                                                                        class="form-control" name="pob" required
                                                                        value="{{ $inboxing->pob }} {{ $inboxing->branches->name }}"
                                                                        disabled readonly />
                                                                    <div class="invalid-feedback">
                                                                        Please enter Names.
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="payment-method" class="form-label">Have P.O
                                                                        Box or Not?</label>
                                                                    ...
                                                                    <select id="selectOption" class="form-control"
                                                                        ...
                                                                        <option value="withoutPostal">Without P.O BOX
                                                                        </option>
                                                                ...
                                                                <div class="col-md-6 mb-3" id="inputContainer">
                                                                    ...
                                                                    <input type="text" name="amount"
                                                                        class="form-control"
                                                                        placeholder="Enter Orgin Country" id="inputField"
                                                                        readonly>
                                                                    <div class="invalid-feedback">
                                                                        Please enter Orgin Country .
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" id="phone-field" name="inname"
                                                                        class="form-control phoneNumber"
                                                                        placeholder="Enter Weight." disabled readonly
                                                                        required value="{{ $inboxing->inname }}" />
                                                                    <div class="invalid-feedback">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" id="customername-field"
                                                                        ...
                                                                        value="{{ $inboxing->phone }}" required disabled
                                                                        readonly />
                                                                    <div class="invalid-feedback">
                                                                        Please enter Orgin Country .
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <select class="form-control" data-choices
                                                                        ...
                                                                        <option
                                                                            @if (old('comment') == 'cash') selected @endif
                                                                            value="cash">Cash</option>
                                                                        <option
                                                                            @if (old('comment') == 'momo') selected @endif
                                                                            value="momo">Momo</option>
                                                                        <option
                                                                            @if (old('comment') == 'pos') selected @endif
                                                                            value="pos">Pos</option>

                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="customername-field" class="form-label">PAY
                                                                        REFERENCE
                                                                    </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="status-field" class="form-label">NATIONAL
                                                                        ID/PASSPORT</label>
                                                                    <select class="form-control" data-choices
                                                                        data-choices-search-false name="nidtype"
                                                                        id="status-field">
                                                                        <option
                                                                            @if (old('nidtype') == 'NID') selected @endif
                                                                            value="NID">NID</option>
                                                                        <option
                                                                            @if (old('nidtype') == 'PASSPORT') selected @endif
                                                                            value="Momo">PASSPORT</option>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="name-field" class="form-label">PICKER
                                                                    NAMES</label>
                                                                <input type="text" id="email-field"
                                                                    class="form-control" name="pknames"
                                                                    placeholder="Enter Picker Names" required
                                                                    value="{{ old('pknames') }}" autocomplete="off" />
                                                                <div class="invalid-feedback">
                                                                    Please Picker Names.
                                                                </div>
                                                            </div>
