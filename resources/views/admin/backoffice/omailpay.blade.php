      ...
      <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">PAYEMENT OF ORDINAL MAILS</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ORDINAL MAILS</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                ...
                                <h5 class="card-title mb-0">PAYEMENT OF ORDINAL MAILS LIST</h5>
                                        ...
                                        <div class="modal fade" id="NotifyModel{{ $inboxing->id }}" tabindex="-1"
                                            ...
                                            <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-light p-3">
                                                            <h5 class="modal-title">PAYEMENT OF ORDINAL MAIL</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close" id="close-modal"></button>
                                                        </div>
                                                        <form class="tablelist-form" id="myForm" method="post" action="{{ route('admin.pay.storeo',$inboxing->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" id="email-field"
                                                                       ...
                                                                       required
                                                                        value="{{ $inboxing->amount }}" readonly />
                                                                    <div class="invalid-feedback">
                                                                        Please enter Names.
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <div class="col-md-6 mb-3">
                                                                            ...
                                                                            <input type="text" id="customername-field"
                                                                                ...
                                                                                placeholder="Enter Orgin NID/PASSPOR"
