    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">PAYEMENT OF EMS</h4>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                ...
                                <h5 class="card-title mb-0">PAYEMENT OF EMS</h5>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light p-3">
                                                        <h5 class="modal-title">PAYEMENT OF EMS</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close" id="close-modal"></button>
                                                    </div>
                                                    <form class="tablelist-form" id="myForm" method="post"
                                                        action="{{ route('admin.emspay.storeems', $inboxing->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" id="customername-field"
                                                                        name="innumber" class="form-control"
                                                                        value="{{ $inboxing->innumber }}" disabled
                                                                        readonly required />
