...
<body>
    ...
    <div class="watermark">DISPATCH REPORT {{ date('M, Y', mktime(0, 0, 0, $date, 1)) }}</div>
 <table width="100%">
<tr>
<td  width="25%">
...
<h2 style="text-align:center">DISPATCH  REPORT ON {{ date('M, Y', mktime(0, 0, 0, $date, 1)) }} </h2>
...
<td > {{ Str::words($inboxing->countryname, 2, ' ...') }}</td>
