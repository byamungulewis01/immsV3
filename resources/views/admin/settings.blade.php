                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                ...
                                <button type="button" class="btn btn-sm btn-success add-btn" data-bs-toggle="modal"
                            ...
                            @foreach ($activities as $key => $activity)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="showModal{{ $activity->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="tablelist-form" method="post"
                                                        action="{{ route('admin.setting.update', $activity->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                        ...
                                        <a href="#deleteRecordModal{{ $activity->id }}" data-bs-toggle="modal"
            ...
            <div class="card" id="customerList">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">Other Systems</h5>
                            </div>
                        </div>
                        ...
                        <tbody class="list form-check-all">
                            @foreach ($settings as $key => $setting)
                                <tr>
                                    ...
                                    <td class="name">{{ $setting->type }}</td>

                                    <td>
                                        <a href="#shwoEditModal{{ $setting->id }}" data-bs-toggle="modal"
                                            type="button" class="btn btn-primary btn-sm"><span>View</span></a>
                                        <div class="modal fade" id="shwoEditModal{{ $setting->id }}" tabindex="-1"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light p-3">
                                                    ...
                                                    <form class="tablelist-form" method="post"
                                                        action="{{ route('admin.setting.othersUpdate', $setting->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <input type="hidden" id="token" value="" />
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="value" class="form-control" id="" rows="4">{{ old('value', $setting->value) }}</textarea>
