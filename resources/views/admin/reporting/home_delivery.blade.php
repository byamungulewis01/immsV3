    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Home Delivery Report</h4>
            ...
            <div class="card">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">Home Delivery Report From {{ (!$startDate) ? now()->format('Y-m-d') : $startDate }} to {{ (!$endDate) ? now()->format('Y-m-d') : $endDate  }} </h5>
                            </div>
                        </div>
