    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Mail Inboxing Report</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ $label }} Mail</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">{{ $label }} outboxing Report From {{ (!$startDate) ? now()->format('Y-m-d') : $startDate }} to {{ (!$endDate) ? now()->format('Y-m-d') : $endDate  }} </h5>
                            </div>
                        </div>
                    ...
                    <table id="datatable" class="table nowrap table-bordered align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="sort" data-sort="weight">Postage</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($collection as $item)
                                <tr>
                                    ...
                                    <td class="weight">{{ $item->total_weight }}</td>
                                    <td class="postage">{{ number_format($item->total_postage, 2) }}</td>
                        ...
                        <tfoot>
                            ...
                            <th colspan="4"></th>
                            <th>{{ number_format($collection->sum('total'), 2) }}</th>
                        </tfoot>
                    </table>
                </div>
            </div>
