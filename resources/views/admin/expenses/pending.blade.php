...
@section('page-name')Pending Expense @endsection
@section('body')
@php
$date = "{}";
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Pending Expense</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Pending Expense Report | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        @php
                            ...
                            // echo $branch_id;
                            //get all expenses from expenses model
                            if (auth()->user()->level == "branchManager") {
                                $expenses = App\Models\Expenses::
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @can('approve expense')
                                <a href="#approveRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('admin.expenses.approve', $expense->e_id) }}"
