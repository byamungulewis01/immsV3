                                        ...
                                        <div class="modal-dialog model-lg">
                                            <div class="modal-content">
                                                <div class="modal-header p-3">
                                                    <h5 class="modal-title" id="exampleModalLabel">expense Type Registration
                                                    </h5>
                                                ...
                                                <form class="tablelist-form" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="e_description" name="e_description" rows="3" placeholder="Enter your comment"></textarea>
                                        ...
                                        @if ($expense->e_status == 2)
                                            ...
                                            @can('delete expense')
                                                <a href="#deleteRecordModal" data-bs-toggle="modal" type="button"
                                                    data-action="{{ route('admin.expenses.destroy', $expense->e_id) }}"
                        ...
                        <form method="post" id="itemupdate" action="#" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="e_name" name="e_name" class="form-control"
                                    placeholder="Title" value="{{ old('e_name') }}" required />
                                <div class="invalid-feedback">
                                    Please enter title.
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="e_file" name="e_file" class="form-control"
                                    placeholder="Attachment" value="{{ old('e_file') }}" />
                                <div class="invalid-feedback">
                                    Please Select Attachment.
                                </div>
                            </div>
