                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalgridLabel">RENTING OF P.O
                                                            BOX {{ $box->pob }}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('physicalPob.pobSellingPut', $box->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="row g-3">
                                                                <div class="col-xxl-6">
                                                                    <div>
                                                                        <label for="firstName" class="form-label">P.O
                                                                            BOX</label>
                                                                        <input type="text" class="form-control"
                                                                            id="firstName" value="{{ $box->pob }}"
                                                                            disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xxl-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="formrow-firstname-input"
                                                                        class="form-label">Client Category </label>
                                                                    <select class="form-select" name="box_category_id"
                                                                        required>
                                                                        <option value="" selected disabled> -- Please
                                                                            Select Box Type -- </option>

                                                                        @foreach (\App\Models\BoxCategory::orderBy('name')->get() as $category)
                                                                            <option value="{{ $category->id }}"
                                                                                {{ old('box_category_id') == $category->id ? 'selected' : '' }}>
                                                                                {{ $category->name }}
                                                                            </option>
                                                                        @endforeach
