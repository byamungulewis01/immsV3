@php
    function convertNumber($num = false)
    {
        ...
        for ($i = 0; $i < count($num_levels); $i++) {
            ...
            $words[] =
                $hundreds . $tens . $singles . ($levels && (int) $num_levels[$i] ? ' ' . $list3[$levels] . ' ' : '');
        } //end for loop
        $commas = count($words);
        if ($commas > 1) {
            $commas = $commas - 1;
...
<body>
    ...
    <b>{{ $item->pobBox->name }} </b> National Post Office <b><em> {{ strtoupper(convertNumber($item->total_amount)) }}
            RWANDA FRANCS ({{ number_format($item->total_amount) }}) </em></b> for:__ <br>
    ...
    <p>
        ...
        @foreach ($years as $key => $value)
            {{ $key + 1 }}. PO BOX Rental Fees
            {{ $value }}......................................................................................................:
            <b>{{ number_format($rent) }} Rwf</b><br>
        @endforeach
        {{ count($years) + 1 }}. VAT of
        18%...............................................................................................................................:
        Included <br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        ...
        <br><br>
        <span style="font-size: 14px; font-weight: bold;">KAYITARE Celestin</span> <br>
        <span style="font-size: 14px;">Director General</span> <br>
        <img src="{{ public_path('images/signature.png') }}" width="140" height="60" alt="">
        <br>
        <span style="font-size: 14px; font-weight: bold;">Digitally Signed</span> <br><br><br>
