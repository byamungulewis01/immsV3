    ...
    <script>
        $(document).ready(function() {
            ...
            $('#datatableAjax').DataTable({
                scrollX: true,
                ajax: "{{ route('physicalPob.pobApi', ['id' => ':branchId']) }}?available={{ request('available') }}"
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            route1 = route1.replace(':id', boxId);
                            var link1 =
                                `<a href="${route1}" target="_blank" class="btn btn-primary btn-sm"><span>P.O B Info</span></a>`;
