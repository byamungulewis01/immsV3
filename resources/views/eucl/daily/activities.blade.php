            ...
            <div class="card">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">Branches Daily Activities </h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="datatable" class="table table-centered table-hover align-middle table-nowrap mb-0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.eucl-reports.daily_transactions',$item->branch_id) }}?date={{ request('date') }}" class="btn btn-sm btn-primary">Transactions</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
