...
<body>
    <div class="watermark">REGISTARED <strong>Ref : # {{ str_pad($outbox->id, 4, '0', STR_PAD_LEFT) }}</strong></div>
    ...
    <center><u>
            <h2> DEPOSIT RECEIPT OF REGISTARED SHIPMENT</h2><u></center>
    ...
    <table border="0" width="100%">
        <tr>
            <td width="50%" style="border: 0px;">
                ...
                <p style="margin-bottom: -4px;">Amounts : {{ number_format($outbox->amount) }} Rwf</p>
            ...
            <td width="50%" style="border: 0px;">
                ...
                <p style="margin-bottom: -4px;"> <span>Done at Kigali on
                        {{ $outbox->created_at->format('Y-m-d') }}</span></p>
