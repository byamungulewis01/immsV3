...
<body>
    <div class="watermark">POSTING WITH TEMBLE SHIPMENT</div>
    ...
    <center><u>
            <h2>RECEIPT OF DEPOSIT OF AN POSTING WITH TEMBLE SHIPMENT</h2><u></center>
    ...
    <table border="0" width="100%">
        <tr>
            <td width="50%" style="border: 0px;">
                {{-- <p style="margin-bottom: -4px;">Product : {{ number_format($outbox->amount) }} Rwf</p>
                <p style="margin-bottom: -4px;">Tax : {{ number_format($outbox->tax) }} Rwf</p> --}}

                {{-- <p style="margin-bottom: -4px;">Weight /kg :  {{ number_format(@$outbox->products->weight) }}</p> --}}
                <p style="margin-bottom: -4px;">Carton/Envelop : {{ number_format($outbox->postage,2) }} Rwf</p>
                <p style="margin-bottom: -4px;"><strong>Total</strong> :  {{ number_format($outbox->postage,2) }} Rwf</p>
    ...
    {{-- <div> Done at Kigali on {{ $outbox->created_at->format('Y-m-d') }}</div>
