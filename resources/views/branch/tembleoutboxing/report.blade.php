...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">POSTING WITH TEMBLE OUTBOXING DAILY REVENUE LIST</h4>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">POSTING WITH TEMBLE OUTBOXING MAIL REVENUE LIST</h5>
                        </div>
                    </div>
                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="sort" data-sort="TRACKING NUMBER">DAILY TEMBLE  REVENUE</th>
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('branch.tembleoutboxing.transactiontemble', $courierPay->pdate) }}" type="button" class="btn btn-success btn-sm" target="_blank"><span>Transactions</span></a>
