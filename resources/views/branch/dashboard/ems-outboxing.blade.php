    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">EMS OUTBOXING</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                        <li class="breadcrumb-item active">EMS OUTBOXING</li>
                    </ol>
                </div>
                            ...
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $total_number }}">{{ $total_number }}</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $current_month }}">{{ $current_month }}</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $last_month }}">{{ $last_month }}</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $districts }}">{{ $districts }}</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $destination }}">{{ $destination }}</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0"><span class="counter-value" data-target="{{ $weights }}">{{ $weights }}</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
