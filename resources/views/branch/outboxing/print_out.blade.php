@php
    ...
    $barcodeImage =
        'data:image/png;base64,' . base64_encode($generator->getBarcode($barcodeData, $generator::TYPE_CODE_128));
@endphp
<!DOCTYPE html>
<html lang="en">
    ...
    <table>
        ...
        <tr>
            <td colspan="3" class="logo">
                <img src="{{ public_path('logo/ems.jpg') }}" alt="" height="">
                <br>
                <b>RWANDA Express</b>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                ...
                @elseif($outbox->type == 'percel')
                    <h3>Percel Mail Outboxing receipt</h3>
                @elseif($outbox->type == 'registered')
                    <h3>Registered Mail Outboxing receipt</h3>
                @else
                    <h3>Temble Mail Outboxing receipt</h3>
                @endif
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                Country : {{ Str::words($outbox->destiny->countryname, 2, ' ...') }}<br>
        ...
        <tr>
            {{-- <td class="border-right">
                <img class="logo" src="{{ public_path('logo/tembre_holder.png') }}" alt="" height="">
            </td> --}}
